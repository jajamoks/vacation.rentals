...
//    dd(Socialite::driver($provider));
    ...
    if($existingUser) {
      ...
      if($provider == "google") $profile_picture->photo_source = 'Google';
      if($provider == "facebook") $profile_picture->photo_source = 'Facebook';
      if($provider == "linkedin") $profile_picture->photo_source = 'LinkedIn';
      ...
      if($provider == "google") $newUser->google_id = $user->id;
    	if($provider == "facebook") $newUser->fb_id = $user->id;
      if($provider == 'linkedin') $newUser->linkedin_id = $user->id;
