        ...
        <footer className="page-container-responsive ng-scope" ng-controller="footer">
          ...
          <div >
            ...
            <ul className="list-layout list-inline text-center">
              ...
              <meta itemProp="logo" />
              <li>
                  <SocialIcon network="facebook"  href="https://www.facebook.com/www.Vacation.Rentals" target="_blank" rel="noopener"/>
                  {/* <span className="screen-reader-only">Facebook</span> */}
              </li>
              <li>
                {/* <span className="screen-reader-only">Reddit</span> */}
                <SocialIcon network="reddit" href="https://www.reddit.com/r/Vacationrentals" target="_blank" rel="noopener"/>
              </li>
              <li>
                {/* <span className="screen-reader-only">Twitter</span> */}
                <SocialIcon network="twitter" href="https://twitter.com/Vacarent" target="_blank" rel="noopener"/>
              </li>
              <li>
                {/* <span className="screen-reader-only">Linkedin</span> */}
                <SocialIcon network="linkedin" href="https://www.linkedin.com/in/vacarent/" target="_blank" rel="noopener"/>
              </li>
              <li>
                {/* <span className="screen-reader-only">Pinterest</span> */}
                <SocialIcon network="pinterest" href="https://www.pinterest.com/nofeevacationrentals" target="_blank" rel="noopener"/>
              </li>
              <li>
                  {/* <span className="screen-reader-only">Youtube</span> */}
                  <SocialIcon network="youtube" href="https://www.youtube.com/vacationrentals" target="_blank" rel="noopener"/>
              </li>
              <li>
                  {/* <span className="screen-reader-only">Instagram</span> */}
                  <SocialIcon network="instagram" href="https://www.instagram.com/vacationhomesforrent" target="_blank" rel="noopener"/>
              </li>
            </ul>
