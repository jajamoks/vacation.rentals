    ...
    axios.post('/ajax/forgot-password', credential)
      .then(response => {
        if (response.data.success == true) {
          ...
          toast.error("No email address matches your entry", {
            position: toast.POSITION.TOP_RIGHT
          });
        }
      })
        ...
        <div className="navik-header header-shadow">
          <div className="container">
            <div className="navik-header-container">
              <ToastContainer />
              <div className="logo" 
                data-mobile-logo="https://res.cloudinary.com/vacation-rentals/image/upload/v1555704142/images/logo.png" 
                data-sticky-logo="https://res.cloudinary.com/vacation-rentals/image/upload/v1555704142/images/logo.png"
              >
                <a href='/'>
                  <img src="https://res.cloudinary.com/vacation-rentals/image/upload/v1555704142/images/logo.png" alt="logo" />
                </a>
              </div>
              <div className="burger-menu">
                <div className="line-menu line-half first-line" />
