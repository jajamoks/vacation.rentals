...
class Booking extends React.Component {
    constructor(props){
        ...
        this.BookItNow = this.BookItNow.bind(this)
    ...
    componentDidMount(){
      console.log('this.props.user_details ===> ', this.props.user_details)
      ...
      // axios.get(`/ajax/rooms/is_bin_enable/${this.props.room_id}`)
      // .then(Response =>{
    ...
    componentWillReceiveProps(nextProps) {
      console.log('nextProps.user_details ==> ', nextProps.user_details)
      this.setState({is_bin_enable: nextProps.user_details.is_bin_enable});
    }
    openChatModal(){
      ...
      BookItNow(){
        if(this.state.isLogedIn == 'true'){
          if(this.props.user_details.id != metas['LogedUserId'].content){
            ...
            if(checkin !=null && checkout != null){
              let url = `https://manage.bookingautomation.com/booking.php?propid=${this.props.user_details.prop_id}&type=0&referer=BookingButton&checkin=${checkin.format('YYYY-MM-DD')}&checkout=${checkout.format('YYYY-MM-DD')}`;
    ...
    render(){
      ...
      console.log('this.state.is_bin_enable   ===> ', this.state.is_bin_enable);
                    ...
                    <div id="book_it" className="display-subtotal" style={{top: '-1px'}}>
                                ...
                                <div className="js-book-it-status">
                                    ...
                                    <div className="js-book-it-enabled clearfix">
                                       ...
                                       {this.state.price_result.status && this.state.price_result.status == 'Not available'  ? this.state.price_result.error : null}
                                        ...
                                        {
                                          ( this.state.is_bin_enable && this.state.is_bin_enable === 1 &&
                                            this.props.user_details.api_key && this.props.user_details.api_key != '' &&
                                            this.props.user_details.prop_id && this.props.user_details.prop_id != '' &&
                                            this.props.user_details.prop_key && this.props.user_details.prop_key != '' &&
                                            this.props.user_details.ota_password && this.props.user_details.ota_password != '' 
                                          ) ? 
                                          (<div className="js-book-it-btn-container row-space-top-2 ">
                                              <button type="button" id="request_book_btn" className="js-book-it-btn btn btn-large btn-block btn-success" onClick={this.BookItNow}>
                                              <span className="book-it__btn-text "><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>
                                                      Book it now
                                                  </font></font></span>
                                              </button>
                        ...
                        <div className="panel wishlist-panel">
                            <div className="panel-body panel-light">
								...
								<div id="contact_wrapper" className="row-space-top-3 text-center">
                                   <a href={ `/ajax/rooms/send-mail-owner/${this.props.room_id}`}>Contact host</a>
