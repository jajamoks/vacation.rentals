        ...
        return(
            <div className="room-section">
                ...
                <div className="" id="map-id" data-reactid=".2" style={{position:'relative'}}>
                    ...
                    {this.props.address ? <GoogleMapContainer zoom={18} onCenterChanged={this.onCenterChanged} onMapMounted={this.onMapMounted} lng={this.props.address ? parseFloat(this.props.address.longitude) : 0} lat={this.props.address ? parseFloat(this.props.address.latitude) : 0} isMarkerShown onBoundsChanged={console.log('')} />: <div> </div>}
